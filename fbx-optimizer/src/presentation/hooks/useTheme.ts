...
const themeStyles: Record<ThemeMode, ThemeStyle> = {
  dark: {
    ...
    button: 'bg-white/5 border border-white/5 text-gray-400 hover:text-white hover:bg-white/10 hover:border-white/10 active:scale-90 active:bg-white/20 active:border-white/20 transition-all duration-150 shadow-sm',
    activeButton: 'bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 text-white border border-blue-400/40 shadow-[0_0_0_3px_rgba(59,130,246,0.15),0_0_20px_-2px_rgba(59,130,246,0.4),0_4px_12px_-2px_rgba(99,102,241,0.3),inset_0_1px_0_rgba(255,255,255,0.15)] active:scale-90 active:shadow-[0_0_0_2px_rgba(59,130,246,0.3),0_0_12px_-2px_rgba(59,130,246,0.5)] transition-all duration-150',
    sceneBg: '#0f172a',
    gridColor: '#334155',
  ...
  light: {
    ...
    button: 'bg-slate-100/50 border border-slate-200 text-slate-500 hover:text-slate-800 hover:bg-slate-100 hover:border-slate-300 active:scale-90 active:bg-slate-200 active:border-slate-400 transition-all duration-150 shadow-sm',
    activeButton: 'bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 text-white border border-blue-400/50 shadow-[0_0_0_3px_rgba(59,130,246,0.2),0_0_20px_-2px_rgba(59,130,246,0.35),0_4px_12px_-2px_rgba(99,102,241,0.25),inset_0_1px_0_rgba(255,255,255,0.2)] active:scale-90 active:shadow-[0_0_0_2px_rgba(59,130,246,0.35),0_0_12px_-2px_rgba(59,130,246,0.5)] transition-all duration-150',
    sceneBg: '#f1f5f9',
    gridColor: '#cbd5e1',
  ...
  cyberpunk: {
    ...
    button: 'bg-neon-blue/5 border border-neon-blue/20 text-neon-purple/70 hover:text-neon-blue hover:bg-neon-blue/10 hover:border-neon-blue/40 active:scale-90 active:bg-neon-blue/25 active:border-neon-blue/60 active:shadow-[0_0_15px_rgba(59,130,246,0.4)] transition-all duration-150 shadow-[0_0_10px_rgba(59,130,246,0.1)]',
    activeButton: 'bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 text-white border border-cyan-400/50 shadow-[0_0_0_3px_rgba(34,211,238,0.2),0_0_24px_-2px_rgba(34,211,238,0.5),0_0_40px_-4px_rgba(168,85,247,0.3),inset_0_1px_0_rgba(255,255,255,0.2)] active:scale-90 active:shadow-[0_0_0_2px_rgba(34,211,238,0.4),0_0_16px_-2px_rgba(34,211,238,0.6)] transition-all duration-150',
    sceneBg: '#020205',
    gridColor: '#a855f7',
  ...
  nord: {
    ...
    button: 'bg-[#434c5e]/50 border border-[#4c566a] text-[#d8dee9]/70 hover:text-[#88c0d0] hover:bg-[#434c5e] hover:border-[#88c0d0]/50 active:scale-90 active:bg-[#5e81ac]/50 active:border-[#88c0d0] transition-all duration-150 shadow-sm',
    activeButton: 'bg-gradient-to-br from-[#88c0d0] via-[#81a1c1] to-[#5e81ac] text-[#2e3440] font-semibold border border-[#88c0d0]/50 shadow-[0_0_0_3px_rgba(136,192,208,0.15),0_0_20px_-2px_rgba(136,192,208,0.4),0_4px_12px_-2px_rgba(94,129,172,0.3),inset_0_1px_0_rgba(255,255,255,0.25)] active:scale-90 active:shadow-[0_0_0_2px_rgba(136,192,208,0.3),0_0_12px_-2px_rgba(136,192,208,0.5)] transition-all duration-150',
    sceneBg: '#2e3440',
    gridColor: '#4c566a',
  ...
  dracula: {
    ...
    button: 'bg-[#6272a4]/30 border border-[#6272a4]/50 text-[#bd93f9]/70 hover:text-[#ff79c6] hover:bg-[#6272a4]/50 hover:border-[#ff79c6]/50 active:scale-90 active:bg-[#bd93f9]/30 active:border-[#ff79c6] transition-all duration-150 shadow-sm',
    activeButton: 'bg-gradient-to-br from-[#ff79c6] via-[#bd93f9] to-[#8be9fd] text-[#282a36] font-bold border border-[#ff79c6]/50 shadow-[0_0_0_3px_rgba(255,121,198,0.15),0_0_20px_-2px_rgba(255,121,198,0.4),0_4px_12px_-2px_rgba(189,147,249,0.3),inset_0_1px_0_rgba(255,255,255,0.25)] active:scale-90 active:shadow-[0_0_0_2px_rgba(255,121,198,0.3),0_0_12px_-2px_rgba(255,121,198,0.5)] transition-all duration-150',
    sceneBg: '#282a36',
    gridColor: '#6272a4',
